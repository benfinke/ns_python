...
"""
BasicNetScalerRecon.py

Ben Finke @benfinke

April 2015

Basic NetScaler Recon is a simple info gathering tool using the Nitro API
"""
...
if __name__ == '__main__':
    try:
        ...
        print("Exception::Usage: BasicNetScalerRecon.py <directory path of Nitro.py> <nsip> <username> <password>")
